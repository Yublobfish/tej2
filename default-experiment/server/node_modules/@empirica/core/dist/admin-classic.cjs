...
var factorsSchema = import_zod2.z.record(import_zod2.z.string().min(1), import_zod2.z.any());
var treatmentSchema = import_zod2.z.object({
...
var FileReadable = class extends import_stream.Readable {
  _read() {
  }
};
