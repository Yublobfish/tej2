...
var Game = class extends BatchOwned {
  ...
  addRound(attributes) {
    ...
    const addStage = (attributes2) => {
      ...
      const res = z.number().int().gte(1).safeParse(durAttr == null ? void 0 : durAttr.value);
      if (!res.success) {
...
var Round = class extends GameOwned {
  ...
  addStage(attributes) {
    ...
    const res = z.number().int().gte(5).safeParse(durAttr == null ? void 0 : durAttr.value);
    if (!res.success) {
      throw new Error(`stage duration invalid: ${res.error}`);
    }
    const duration = res.data;
 ...
 * MIT Licensed
 */
//# sourceMappingURL=chunk-BJAGXXFU.js.map