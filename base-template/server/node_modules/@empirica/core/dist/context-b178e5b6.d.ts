...
import { A as Attributes$1, a as Attribute, G as Globals$1, J as JsonValue, b as AttributeOptions, S as ScopeConstructor, c as Scopes$1, d as ScopeUpdate, e as ScopeIdent, f as Scope$1 } from './globals-1dc2e2b1.js';
...
declare type ScopeMsg<Context, Kinds extends {
...
declare class Scopes<Context, Kinds extends {
    ...
    private kindSubs;
    constructor(scopesObs: Observable<ScopeUpdate>, donesObs: Observable<void>, ctx: Context, kinds: Kinds, attributes: Attributes, taj: TajribaAdminAccess);
...
declare type SimpleListener<Context, Kinds extends {
    [key: string]: ScopeConstructor<Context, Kinds>;
}> = {
    placement: ListernerPlacement;
    callback: (ctx: EventContext<Context, Kinds>) => void;
};
declare type TajEventListener<Callback extends Function> = {
    placement: ListernerPlacement;
    event: TajribaEvent;
    callback: Callback;
};
declare type KindEventListener<Callback extends Function> = {
    placement: ListernerPlacement;
    kind: string;
    callback: Callback;
};
declare type AttributeEventListener<Callback extends Function> = {
    placement: ListernerPlacement;
    kind: string;
    key: string;
    callback: Callback;
...
declare class ListenersCollector<Context, Kinds extends {
    ...
    readonly attributeListeners: AttributeEventListener<EvtCtxCallback<Context, Kinds>>[];
...
declare class EventContext<Context, Kinds extends {
    ...
    private taj;
    private scopes;
    constructor(subs: SubscriptionCollector, taj: TajribaAdminAccess, scopes: Scopes<Context, Kinds>);
...
export { AdminContext as A, EventContext as E, Finalizer as F, ListenersCollector as L, Scope as S, TajribaEvent as T, Attributes as a, AdminConnection as b, Subscriber as c, Scopes as d, Subscriptions as e, ScopeSubscriptionInput as f, Subs as g, AddLinkPayload as h, AddTransitionPayload as i };
