import { S as Scope, E as EventContext, L as ListenersCollector } from './context-b178e5b6.js';
import { J as JsonValue, b as AttributeOptions, C as Constructor } from './globals-1dc2e2b1.js';
...
declare class Game extends BatchOwned {
    ...
    addRound(attributes: {
        ...
        addStage: (attributes: AttributeInput[] | {
            [key: string]: JsonValue;
        }) => {
            readonly get: (key: string) => any;
            readonly set: (key: string, value: JsonValue, ao?: Partial<AttributeOptions> | undefined) => void;
...
declare function Classic({ disableAssignment, disableIntroCheck, disableGameCreation, }?: ClassicConfig): (_: ListenersCollector<Context, ClassicKinds>) => void;
...
export { Batch as B, Classic as C, EventProxy as E, Game as G, Player as P, Round as R, Stage as S, ClassicListenersCollector as a, ClassicLoader as b, classicKinds as c, Context as d, ClassicKinds as e, evt as f, PlayerGame as g, PlayerRound as h, PlayerStage as i };
